const Feed = () => (
  ...
  >
    <g fill="none" stroke="gray" strokeWidth="1.5">
      ...
      <path d="M6 12c0-1.414 0-2.121.44-2.56C6.878 9 7.585 9 9 9h6c1.414 0 2.121 0 2.56.44c.44.439.44 1.146.44 2.56v4c0 1.414 0 2.121-.44 2.56c-.439.44-1.146.44-2.56.44H9c-1.414 0-2.121 0-2.56-.44C6 18.122 6 17.415 6 16v-4Z" />
      <path d="M7 6h5" strokeLinecap="round" />
    </g>
  </svg>
);
